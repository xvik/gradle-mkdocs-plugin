...
* Update mkdocs.yaml generated by init task: 
  - all extensions enabled 
  - added dark theme toggle by default
  - enable some navigation features
  - activate google docs with theme configuration
